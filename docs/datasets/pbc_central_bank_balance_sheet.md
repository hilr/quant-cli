...
|------|------|
| date | 月份 YYYY-MM |
| item | 项目名（资产方 + 负债方全明细，「其中：」明细带父级） |
| value | 月末余额（亿元） |

**item 包括**（按出现顺序）：资产方——国外资产（外汇、货币黄金、其他国外资产）、对政府债权（`对政府债权·其中：中央政府`）、对其他存款性公司债权、对其他金融性公司债权、对非金融性部门债权、其他资产、**总资产**；负债方——储备货币（货币发行、金融性公司存款、其他存款性公司存款、其他金融性公司存款、非金融机构存款）、不计入储备货币的金融性公司存款、发行债券、国外负债、政府存款（`政府存款·其中：中央政府`）、自有资金、其他负债、**总负债**。
...
- **「其中：」明细消歧**：资产方「对政府债权」与负债方「政府存款」下都有「其中：中央政府」，用「·」补父级区分：`对政府债权·其中：中央政府`、`政府存款·其中：中央政府`，保证 `(date,item)` 唯一。
- **全明细输出**：约 22 个项目行/月。项目名已去英文翻译、折叠空白。
